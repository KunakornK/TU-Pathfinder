...
public class MainActivity extends AppCompatActivity {
    ...
    private final ActivityResultLauncher<String> activityResultLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
        ...
        public void onActivityResult(Boolean result) {
            if(result){
                ...
                Toast.makeText(MainActivity.this,"Permission Not Granted Please Give permission And Restart",Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapboxMap().loadStyleUri(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                locationPuck2D.setBearingImage(AppCompatResources.getDrawable(MainActivity.this,R.drawable.baseline_accessibility_24));
                ...
                addOnMapClickListener(mapView.getMapboxMap(), new OnMapClickListener() {
                    ...
                    public boolean onMapClick(@NonNull Point point) {
                        ...
                        PointAnnotationOptions pointAnnotationOptions = new PointAnnotationOptions().withTextAnchor(TextAnchor.CENTER).withIconImage(resized).withPoint(point);
    ...
    private void fineRoute(Point point){
        ...
        locationEngine.getLastLocation(new LocationEngineCallback<LocationEngineResult>() {
            ...
            public void onSuccess(LocationEngineResult result) {
                ...
                setRoute.setText("Finding Route..");
                ...
                applyDefaultNavigationOptions(builder).profile(DirectionsCriteria.PROFILE_WALKING);
